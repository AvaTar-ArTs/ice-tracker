/**
 * v6: Express + static + /api/ice-news + optional SSE for live refresh.
 * Same RSS aggregation as v5; SSE lets clients get notified when feed updates.
 */
...
const parser = new Parser({
  timeout: 10000,
  headers: { "User-Agent": "ICE-Tracker/6.0 (Transparency)" },
});
...
app.listen(PORT, () => {
  console.log(`ICE Tracker v6 at http://localhost:${PORT}`);
});
