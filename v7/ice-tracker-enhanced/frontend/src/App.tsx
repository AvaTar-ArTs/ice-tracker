...
import { Container, Box, AppBar, Toolbar, Typography, IconButton, useMediaQuery } from '@mui/material';
            ...
            <Route path="/dashboard" element={
              <Box display="flex" flexDirection="column" height="100%">
                <Typography variant="h4" gutterBottom>
                  ICE Activity Dashboard
                </Typography>
                <Box display="flex" flex={1} gap={2} height="calc(100vh - 200px)">
                  <ActivityMap />
                  <ActivityList />
                </Box>
              </Box>
