/** Site metadata and strings for ICE Activity Tracker (v4). */
...
export const SITE_DESCRIPTION =
  "Track U.S. Immigration and Customs Enforcement (ICE) activity: live feed of enforcement news, ERO field offices, Know Your Rights, rapid response hotlines, in-browser AI summaries, and community reports by state.";
export const SITE_DESCRIPTION_SHORT =
  "Live ICE activity tracker: enforcement news, ERO offices, Know Your Rights, hotlines, in-browser AI summaries, raids & arrests by state.";
...
export const SEO_FAQS = [
  {
    ...
    answer:
      "ICE Activity Tracker is a live map and news feed for U.S. Immigration and Customs Enforcement (ICE) activity. It shows recent enforcement news, ERO field office locations, in-app Know Your Rights and rapid response hotlines by state, in-browser AI summaries (no API keys), and lets you add community reports by state.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Data comes from official ICE.gov RSS feeds (Enforcement & Removal, Breaking News, and state-specific feeds), plus in-app Know Your Rights and hotline directory, and optional community reports stored in your browser. AI summaries run in your browser (Transformers.js) with no server API keys.",
  },
];
