/**
 * SEO, GEO, XEO/DEO & trending/rising keyword config for ICE Activity Tracker.
 * Optimized for top 1–5% hot trending / +200% rising search visibility.
 * Use NEXT_PUBLIC_SITE_URL in production (e.g. https://ice-tracker.example.com).
 */
...
/**
 * Primary + Ahrefs-style keywords:
 * - Informational intent (what is, how to)
 * - "Also rank for" / phrase-match (state, today, near me)
 * - Commercial/navigational (tracker, map, offices)
 */
...
/** Geographic coverage for GEO SEO (USA) */
...
/** FAQ for FAQPage schema (trending Q&A intent) */
